...
export const desktopChannels = {
  ...
  manuscriptDocumentsChanged: "desktop:manuscript-documents-changed",
...
export const manuscriptDocumentsChangedEventSchema = manuscriptListResultSchema;
...
export const materialTitleSchema = z.string().trim().min(1).max(200);

export const materialReadResultSchema = z.discriminatedUnion("outcome", [
  z
    .object({
      outcome: z.literal("success"),
...
export const materialImportResultSchema = z.discriminatedUnion("outcome", [
  z
    .object({
      outcome: z.literal("success"),
      material: z
        .object({
          title: materialTitleSchema,
          inputEncoding: z.enum(["utf-8", "gb2312", "gbk", "gb18030"]),
          created: z.boolean(),
        })
        .strict(),
    })
...
export const renameDesktopMaterialInputSchema = z
  .object({
    title: materialTitleSchema,
    newTitle: materialTitleSchema,
  })
  .strict();

export const materialRenameResultSchema = z.discriminatedUnion("outcome", [
...
export type ManuscriptDocumentsChangedEvent = z.infer<typeof manuscriptDocumentsChangedEventSchema>;
...
export type MaterialReadResult = z.infer<typeof materialReadResultSchema>;
...
export interface CleoDocDesktopApi {
  ...
  readonly onManuscriptDocumentsChanged: (
