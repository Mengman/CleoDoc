...
export function createDesktopMaterialServiceOptions(
  config: SoftwareConfig,
  resourceRoot: string,
): MaterialServiceOptions {
  // Create the existing material service configuration for desktop import tasks.
  return {
...
function createEmbeddingModel(
  ...
  // Adapt the local embedding runtime to the MaterialService model contract.
  return {
